...
// ---- Subtopics Jr
  Future<void> _insertSubtopicsJrLevel1(db) async {
    ...
    await db.insert('subtopic', {
      ...
      'id': 's01t01', // Subtopic 1 del Topic 1
      'module': 'Jr',
      'title': 'var',
    });
    ...
    await db.insert('subtopic', {
      ...
      'id': 's01t03', // Subtopic 1 del Topic 3
      'module': 'Jr',
    ...
    await db.insert('subtopic', {
      ...
      'id': 's01t04', // Subtopic 1 del Topic 4
      'module': 'Jr',
    ...
    await db.insert('subtopic', {
      ...
      'id': 's01t05', // Subtopic 1 del Topic 5
      'module': 'Jr',
      'title': 'if',
    });
  ...
  Future<void> _insertSubtopicsJrLevel3(db) async {
    ...
    await db.insert('subtopic', {
      ...
      'id': 's01t06', // Subtopic 1 del Topic 6
      'module': 'Jr',
